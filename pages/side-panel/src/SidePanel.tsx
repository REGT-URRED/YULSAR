...
const SidePanel = () => {
  ...
  return (
    <div>
      <div
        className={`flex h-screen flex-col ${isDarkMode ? 'bg-onyx' : 'bg-slate-50'} overflow-hidden border ${isDarkMode ? 'border-crimson-700' : 'border-[rgb(186,230,253)]'} rounded-2xl`}>
        <header className="header relative">
          <div className="header-logo">
            {showHistory ? (
              <button
                ...
                className={`${isDarkMode ? 'text-sky-400 hover:text-crimson-300' : 'text-sky-400 hover:text-crimson-400'} cursor-pointer`}
          ...
          <div className="header-icons">
            {!showHistory && (
              <>
                <button
                  ...
                  className={`header-icon ${isDarkMode ? 'text-sky-400 hover:text-crimson-300' : 'text-sky-400 hover:text-crimson-400'} cursor-pointer`}
            ...
            <a
              ...
              className={`header-icon ${isDarkMode ? 'text-sky-400 hover:text-crimson-300' : 'text-sky-400 hover:text-crimson-400'}`}>
                ...
                <div className="max-w-md text-center">
                  ...
                  <button
                    ...
                    className={`my-4 rounded-lg px-4 py-2 font-medium transition-colors ${
                      isDarkMode ? 'bg-sky-600 text-white hover:bg-crimson-700' : 'bg-sky-500 text-white hover:bg-crimson-600'
                    }`}>
                  ...
                  <div className="mt-4 text-sm opacity-75">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`${isDarkMode ? 'text-sky-400 hover:text-crimson-300' : 'text-sky-700 hover:text-sky-600'}`}>
            ...
            {hasConfiguredModels === true && (
              <>
                {messages.length === 0 && (
                  <>
                    <div
                      className={`border-t ${isDarkMode ? 'border-crimson-800' : 'border-crimson-100'} mb-2 p-2 shadow-sm backdrop-blur-sm`}>
                      <ChatInput
                ...
                {messages.length > 0 && (
                  <div
                    className={`scrollbar-gutter-stable flex-1 overflow-x-hidden overflow-y-scroll scroll-smooth p-2 ${isDarkMode ? 'bg-onyx/80' : ''}`}>
                ...
                {messages.length > 0 && (
                  <div
                    className={`border-t ${isDarkMode ? 'border-crimson-800' : 'border-crimson-100'} p-2 shadow-sm backdrop-blur-sm`}>
                    <ChatInput
                      onSendMessage={handleSendMessage}
                      onStopTask={handleStopTask}
                      onMicClick={handleMicClick}
